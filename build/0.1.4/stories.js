...
const index_2 = __webpack_require__(41);
const registerTick_1 = __webpack_require__(84);
const types_1 = __webpack_require__(9);
// TODO 修复这里的BUG
const BulletExplosion = registerTick_1.default(1000, 1000, 1000)(Explosion_1.default);
const TankExplosion = registerTick_1.default(1000, 1000)(Explosion_1.default);
...
class FlickerStory extends React.PureComponent {
    ...
    render() {
        ...
        return (React.createElement(Flicker_1.default, { flicker: types_1.FlickerRecord({
                flickerId: 1,
                x: 0,
                y: 0,
                shape,
        ...
        return (React.createElement("div", { className: "stories", style: { fontFamily: 'monospace', margin: 8 } },
            ...
            React.createElement("details", { open: true },
                ...
                React.createElement(Row, null,
                    ...
                    React.createElement(X4, null,
                        React.createElement(FlickerStory, null))),
                React.createElement(Row, null,
                    React.createElement(X4, null,
