...
var EagleRecord_1 = __webpack_require__(15);
...
var players_1 = __webpack_require__(24);
exports.PlayersMap = players_1.PlayersMap;
var bullets_1 = __webpack_require__(25);
exports.BulletsMap = bullets_1.BulletsMap;
var texts_1 = __webpack_require__(27);
exports.TextsMap = texts_1.TextsMap;
var tanks_1 = __webpack_require__(26);
exports.TanksMap = tanks_1.TanksMap;
var scores_1 = __webpack_require__(28);
...
Object.defineProperty(exports, "__esModule", { value: true });
const redux_saga_1 = __webpack_require__(9);
const effects_1 = __webpack_require__(14);
...
function getTankBulletSpeed(tank) {
    if (tank.side === 'human') {
        if (tank.level === 'basic') {
            return 2 * constants_1.BULLET_MOVE_SPEED_UNIT;
        }
        else {
            return 3 * constants_1.BULLET_MOVE_SPEED_UNIT;
        }
    }
    else {
        if (tank.level === 'basic') {
            return constants_1.BULLET_MOVE_SPEED_UNIT;
        }
...
function getTankMoveSpeed(tank) {
    if (tank.side === 'human') {
        return 2 * constants_1.TANK_MOVE_SPEED_UNIT;
    }
    else if (tank.level === 'basic') {
        return constants_1.TANK_MOVE_SPEED_UNIT;
    }
    else if (tank.level === 'fast') {
        return 3 * constants_1.TANK_MOVE_SPEED_UNIT;
    }
    else {
        return 2 * constants_1.TANK_MOVE_SPEED_UNIT;
    }
...
exports.TANK_MOVE_SPEED_UNIT = 0.02;
/** 子弹飞行速度单位. 玩家坦克2x(如果没升级的话), basic-tank 1x, power-tank 3x, 其他坦克2x */
exports.BULLET_MOVE_SPEED_UNIT = 0.08;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__effects__ = __webpack_require__(14);
...
function proc(iterator) {
  ...
  **/
  ...
  function end(result, isErr) {
    ...
    if (!isErr) {
      if (false) {
        log('debug', name + ' has been cancelled', '');
      }
...
Object.defineProperty(exports, "__esModule", { value: true });
const stageConfigs = {};
const requireStage = __webpack_require__(61);
...
const immutable_1 = __webpack_require__(0);
const constants_1 = __webpack_require__(6);
const EagleRecord_1 = __webpack_require__(15);
...
const players_1 = __webpack_require__(24);
const bullets_1 = __webpack_require__(25);
const explosions_1 = __webpack_require__(97);
const flickers_1 = __webpack_require__(99);
const map_1 = __webpack_require__(100);
const tanks_1 = __webpack_require__(26);
const texts_1 = __webpack_require__(27);
const powerUps_1 = __webpack_require__(102);
const scores_1 = __webpack_require__(28);
...
Object.defineProperty(exports, "__esModule", { value: true });
const immutable_1 = __webpack_require__(0);
const parseStageEnemies_1 = __webpack_require__(60);
const stages_1 = __webpack_require__(23);
...
module.exports = {"name":"1","difficulty":1,"map":["X  X  X  X  X  X  X  X  X  X  X  X  X  ","X  Bf X  Bf X  Bf X  Bf X  Bf X  Bf X  ","X  Bf X  Bf X  Bf X  Bf X  Bf X  Bf X  ","X  Bf X  Bf X  Bf Tf Bf X  Bf X  Bf X  ","X  Bf X  Bf X  X  X  Bf F  Bf X  Bf X  ","X  F  F  F  F  Bf X  Bf F  F  X  X  X  ","Tc X  Bc BF R  R  R  R  R  BF BF X  Tc ","X  X  X  X  S  BF Bc Bf S  X  X  X  X  ","X  BF X  BF X  BF B3 BF X  BF X  BF X  ","X  BF X  BF X  BF X  BF X  BF X  BF X  ","X  BF X  BF X  X  X  X  X  BF X  BF X  ","X  BF X  BF X  B8 Bc B4 X  BF X  BF X  ","X  X  X  X  X  Ba EE B5 X  X  X  X  X  "],"enemies":["18*basic","2*fast"]}
...
Object.defineProperty(exports, "__esModule", { value: true });
const immutable_1 = __webpack_require__(0);
const ExplosionRecord_1 = __webpack_require__(98);
function explosions(state = immutable_1.Map(), action) {
    if (action.type === 'SPAWN_EXPLOSION') {
        let foo;
        return state.set(action.explosionId, ExplosionRecord_1.default(action));
    }
...
function flickers(state = immutable_1.Map(), action) {
    if (action.type === 'SPAWN_FLICKER') {
        return state.set(action.flickerId, types_1.FlickerRecord(action));
    }
...
const stages_1 = __webpack_require__(23);
const types_1 = __webpack_require__(2);
function mapReducer(state = types_1.mapRecord, action) {
